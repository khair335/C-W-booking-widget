...
import LayoutWrapperAccountSettingsSideNav from './LayoutWrapperSettingsSideNavigation';

import css from './LayoutSettingsSideNavigation.module.css';

// Commonly used layout
const LayoutSettingsSideNavigation = props => {
  const {
    className,
    rootClassName,
    containerClassName,
...
LayoutSettingsSideNavigation.displayName = 'LayoutSettingsSideNavigation';

LayoutSettingsSideNavigation.defaultProps = {
  className: null,
  rootClassName: null,
  sideNav: null,
  footer: null,
...
LayoutSettingsSideNavigation.propTypes = {
  className: string,
...
export default LayoutSettingsSideNavigation;
