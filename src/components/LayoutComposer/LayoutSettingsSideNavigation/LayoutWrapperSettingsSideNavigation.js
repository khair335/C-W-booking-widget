...
import css from './LayoutSettingsSideNavigation.module.css';
...
const LayoutWrapperSettingsSideNavigationComponent = props => {
  ...
  const tabs = userType == CREATOR_USER_TYPE ? audienceTabs.filter((e) => e.id != 'ProfileSettingsPageTab') : audienceTabs;
...
LayoutWrapperSettingsSideNavigationComponent.defaultProps = {
  className: null,
  rootClassName: null,
  children: null,
  currentPage: null,
...
LayoutWrapperSettingsSideNavigationComponent.propTypes = {
  children: node,
  className: string,
...
const LayoutWrapperSettingsSideNavigation = compose(withViewport)(
  LayoutWrapperSettingsSideNavigationComponent
);

export default LayoutWrapperSettingsSideNavigation;
