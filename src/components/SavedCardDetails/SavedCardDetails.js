      ...
      {onManageDisableScrolling ? (
        ...
        >
          <div className={css.paymentCompletedModal}>
            <h4 className={css.paymentCompletedHeading}>{removeCardModalTitle}</h4>
            <div>
              <p className={css.paymentCompletedSubHeading}>{removeCardModalContent}</p>
              <div >
                <Button onClick={onDeleteCard} className={css.paymentCompletedStartWatching} inProgress={deletePaymentMethodInProgress}>
                 <span> {removeCard}</span>
                </Button>
                <div
                  onClick={() => setIsModalOpen(false)}
                  className={css.paymentCompletedMoreContent}
                  tabIndex="0"
                >
                  {cancel}
                </div>
