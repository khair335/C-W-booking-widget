...
export const transitions = {
  ...
  CREATE_PAYOUT: 'transition/create-payout',
  ...
  REFUND_REQUEST: 'transition/refund-request',
  APPROVE_REFUND_REQUEST: 'transition/approve-refund-request',
  APPROVE_REFUND_REQUEST_BY_ADMIN: 'transition/approve-refund-request-by-admin',
  REJECT_REFUND_REQUEST_BY_ADMIN: 'transition/reject-refund-request-by-admin',
  REVIEW_BY_CUSTOMER: 'transition/review-by-customer',
  REVIEW_BY_CUSTOMER_AFTER_PAYOUT: 'transition/review-by-customer-after-payout',
  CREATE_PAYOUT_AFTER_REVIEW: 'transition/create-payout-after-review',
  EXPIRE_REVIEW_PERIOD_AFTER_PURCHASED: 'transition/expire-review-period-after-purchased',
...
export const states = {
  ...
  REQUEST_TO_REFUND: 'request-to-refund',
...
export const graph = {
  ...
  states: {
    ...
    [states.COMPLETED]: {
      on: {
        [transitions.REFUND_REQUEST]: states.REQUEST_TO_REFUND,
        [transitions.CREATE_PAYOUT]: states.PAYOUT_CREATED,
    ...
    [states.PAYOUT_CREATED]: {
      on: {
        ...
        [transitions.REVIEW_BY_CUSTOMER_AFTER_PAYOUT]: states.REVIEWED,
      },
    },

    [states.REQUEST_TO_REFUND]: {
      on: {
        [transitions.APPROVE_REFUND_REQUEST]: states.REFUND_REQUEST_APPROVED,
        [transitions.APPROVE_REFUND_REQUEST_BY_ADMIN]: states.REFUND_REQUEST_APPROVED,
        [transitions.REJECT_REFUND_REQUEST_BY_ADMIN]: states.REFUND_REQUEST_REJECTED
      },
    },
    ...
    [states.REVIEWED]: {
      on: {
        [transitions.CREATE_PAYOUT_AFTER_REVIEW]: states.ORDER_COMPLETED,
      },
    },
    // [states.REVIEWED]: { type: 'final' },
    [states.ORDER_COMPLETED]: { type: 'final' },
    [states.REFUND_REQUEST_APPROVED]: { type: 'final' },
    [states.REFUND_REQUEST_REJECTED]: { type: 'final' },
  },
};
...
export const isRelevantPastTransition = transition => {
  return [
    ...
    transitions.APPROVE_REFUND_REQUEST,
    transitions.REFUND_REQUEST,
    transitions.APPROVE_REFUND_REQUEST_BY_ADMIN,
    transitions.REJECT_REFUND_REQUEST_BY_ADMIN,
    transitions.REVIEW_BY_CUSTOMER_AFTER_PAYOUT,
  ].includes(transition);
};
export const isCustomerReview = transition => {
  return [transitions.REVIEW_BY_CUSTOMER, transitions.REVIEW_BY_CUSTOMER_AFTER_PAYOUT, transitions.REVIEW_2_BY_CUSTOMER].includes(transition);
};
