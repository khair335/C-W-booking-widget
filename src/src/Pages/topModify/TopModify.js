...
export default function Modify() {
  ...
  const handleNextClick = async () => {
    ...
    try {
      ...
      // Navigate to edit page based on selected restaurant
      const editPage = selectedRestaurant === 'top' ? "/TopEdit" : "/Edit";
      navigate(editPage, {
        state: {
          bookingNumber,
          bookingData
        ...
        <div className={styles.modify_container}>
          ...
          {!selectedRestaurant ? (
            <>
              ...
              <div className={styles.restaurant_selection}>
                ...
                <div className={`${styles.restaurant_option} ${selectedRestaurant === 'top' ? styles.selected : ''}`}>
                  <img src={logo} alt="Tap & Run" className={styles.restaurant_logo} />
                ...
                <div className={`${styles.restaurant_option} ${selectedRestaurant === 'griffin' ? styles.selected : ''}`}>
                  <img src={griffinlogo} alt="The Griffin Inn" className={styles.restaurant_logo} />
            ...
            <>
              ...
              <div className={styles.Data_type}>
                <img src={selectedRestaurant === 'top' ? logo : griffinlogo} alt="logo" />
              </div>
