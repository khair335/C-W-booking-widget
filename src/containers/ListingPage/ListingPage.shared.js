...
import { AUDIENCE_USER_TYPE } from '../../util/types';
import Skeleton from '../../components/Skeleton/Skeleton';
import styles from './ListingBannerDetails/ListingBannerDetails.module.css';
/**
...
export const handleContactUser = parameters => () => {
  ...
  if (!currentUser) {
    ...
    history.push(createResourceLocatorString('SignupForUserTypePage', routes, { userType: AUDIENCE_USER_TYPE }, {}), state);
...
export const handleSubmit = parameters => values => {
  ...
  if (!currentUser) {
    const state = { from: `${location.pathname}${location.search}`, to: 'checkout' };
        ...
        <div className={styles.container}>
          <div className={styles.content}>
            ...
            <div className={styles.rightSection}>
              ...
              <Skeleton width="20%" height={'10px'} rounded={0} bottom={12} /><br />
              <Skeleton width="60%" height={'10px'} rounded={0} bottom={12} /><br />
              <Skeleton width="20%" height={'40px'} rounded={30} bottom={12} /><br />
              <Skeleton width="100%" height={'10px'} rounded={0} bottom={7} />
              <Skeleton width="90%" height={'10px'} rounded={0} bottom={7} />
              <Skeleton width="80%" height={'10px'} rounded={0} bottom={12} />
            </div>
          </div>
        </div>
      </div>
