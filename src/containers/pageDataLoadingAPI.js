 ...
 */
import { loadData as AuthenticationPageLoader, loadData } from './AuthenticationPage/AuthenticationPage.duck';
...
import { loadData as MyLibraryPageLoader } from './MyLibraryPage/MyLibraryPage.duck';
import { loadData as CreatorLandingPageLoader } from './CreatorLandingPage/CreatorLandingPage.duck';
import { loadData as SeriesPageLoader } from './SeriesPage/SeriesPage.duck';
import { loadData as FilmsPageLoader } from './FilmsPage/FilmsPage.duck';
...
const getPageDataLoadingAPI = () => {
  return {
    ...
    MyLibraryPage: {
      loadData: MyLibraryPageLoader,
    },
    CreatorLandingPage: {
      loadData: CreatorLandingPageLoader,
    },
    SeriesPage: {
      loadData: SeriesPageLoader
    },
    FilmsPage: {
      loadData: FilmsPageLoader
    }
  };
};
