...
const TransitionMessage = props => {
  ...
  const { reportedIssue } = (transaction && transaction.id && transaction.attributes.protectedData) || {};
  ...
  const message = intl.formatMessage(
    ...
    { actor, otherUsersName, listingTitle, reviewLink, deliveryMethod, stateStatus, reportedIssue }
  );
