...
import { updateAlgoliaEntityViews } from '../../util/api';
...
export const loadData = (params, search, config) => (dispatch, getState, sdk) => {
  ...
  // do not update the views count for a user in algolia if the user is browsing own profile
  const notOwnProfile = currentUser?.id?.uuid !== userId?.uuid;
