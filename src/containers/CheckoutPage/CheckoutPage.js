...
const EnhancedCheckoutPage = props => {
  ...
  const listingType = (listing?.attributes?.publicData?.listingType == FILM_PRODUCTS ? FILM_LABEL : SERIES_LABEL) || '';
...
const mapDispatchToProps = dispatch => ({
  ...
  onConfirmPayment: (transactionId, transitionName, transitionParams, listingId) =>
    dispatch(confirmPayment(transactionId, transitionName, transitionParams, listingId)),
