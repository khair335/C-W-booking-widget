...
const PaymentCompletedPage = loadable(() => import(/* webpackChunkName: "PaymentCompletedPage" */ '../containers/PaymentCompletedPage/PaymentCompletedPage'));

const MyLibraryPage = loadable(() => import(/* webpackChunkName: "StyleguidePage" */'../containers/MyLibraryPage/MyLibraryPage'));
const VideoViewerPage = loadable(() => import(/* webpackChunkName: "VideoViewerPage" */'../containers/VideoViewerPage/VideoViewerPage'));
const CreatorLandingPage = loadable(() => import(/* webpackChunkName: "CreatorLandingPage" */ '../containers/CreatorLandingPage/CreatorLandingPage'));
const SeriesPage = loadable(() => import(/* webpackChunkName: "SeriesPage" */'../containers/SeriesPage/SeriesPage'));

const FilmsPage = loadable(() => import(/* webpackChunkName: "FilmsPage" */'../containers/FilmsPage/FilmsPage'));
...
const routeConfiguration = (layoutConfig, accessControlConfig) => {
  ...
  //   ? SearchPageWithMap 
  //   : SearchPageWithGrid;
  const SearchPage = AlgoliaSearchPage;
  ...
  return [
    ...
    },
    {
      ...
      loadData: pageDataLoadingAPI.CreatorLandingPage.loadData,
    },
    {
      path: '/p/:pageId',
      name: 'CMSPage',
    ...
    },
    {
      ...
      component: () => (
        <NamedRedirect
          name="SearchPage"
          params={{ searchId: LISTING_SEARCH_ID }}
        />
      ),
    },
    {
    ...
    },
    {
      ...
      component: () => (
        <NamedRedirect
          ...
          params={{ slug: draftSlug, id: draftId, type: 'new', tab: 'details', listingType:'film_products' }}
        />
      ),
    },
    ...
    {
      path: '/l/:slug/:id/:type/:tab/:listingType',
      name: 'EditListingPage',
      auth: true,
      authPage: 'LoginPage',
      component: EditListingPage,
    ...
    {
      path: '/l/:slug/:id/:type/:tab/:listingType/:returnURLType',
    ...
    {
      path: '/creator/:username/:id/:variant',
    ...
    {
      path: '/profile-settings/:userType',
    ...
    },
    {
      ...
      loadData: pageDataLoadingAPI.MyLibraryPage.loadData,
    },
    {
      path: '/series',
      name: 'SeriesPage',
      component: SeriesPage,
      loadData: pageDataLoadingAPI.SeriesPage.loadData,
    },
    {
      path: '/films',
      name: 'FilmsPage',
      component: FilmsPage,
      loadData: pageDataLoadingAPI.FilmsPage.loadData,
    }
  ];
};
