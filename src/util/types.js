...
export const CREATOR_USER_TYPE = "creator";
export const AUDIENCE_USER_TYPE = "audience";

// fields name 

export const ROLE = "role";
export const CUSTOM_ROLE = 'custom_role';
export const PRICES = "suggested_prices";
export const REFUND_POLICY = 'refund_policy';

//fields name with pub_ for film

export const PUB_SUB_GENRE = 'pub_sub_genre';
export const PUB_SUBTITLE_SELECTION = 'pub_subtitle_selection';
export const PUB_PRIMARY_GENRE = 'pub_primary_genre';

//fields name with pub_ for series

export const PUB_SERIES_SUB_GENRE = "pub_series_sub_genre";
export const PUB_SERIES_PRIMARY_GENRE = 'pub_series_primary_genre';

//fields name with pub_ for user

export const PUB_CONTENT_TYPE = "pub_content_type";

export const urlsFieldName = ["pub_instagram_url", "pub_facebook_url", "pub_tiktok_url", "pub_linkedIn_url", "pub_youtube_url", "pub_website_url", "pub_x_url", "pub_spotify_url"];

//listing type
export const FILM_PRODUCTS = "film_products";
export const SERIES_PRODUCTS = "series_products";
export const LIVE_EVENT_PRODUCTS = "live_event_products";
...
export const FILM_TAB = "film_tab";
export const CAST_CREW = "cast_crew";
export const PURCHASES_TAB = "purchases";
export const WISHLIST_TAB = "wishlist";

// Listing types label
export const FILM_LABEL = "Film";
...
propTypes.creator = shape({
  id: string.isRequired,
  name: string.isRequired,
  username: string.isRequired,
  image: string.isRequired,
  marketingPosters: arrayOf(string),
  realUserName: string.isRequired,
});
