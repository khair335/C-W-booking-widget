  ...
  useEffect(() => {
    const fetchAvailability = async () => {
      ...
      try {
        ...
        console.log("Edit - Making AvailabilitySearch API call to:", `/api/ConsumerApi/v1/Restaurant/${restaurant}/AvailabilitySearch`);
        console.log("Edit - Current pathname:", window.location.pathname);
        console.log("Edit - Detected restaurant:", restaurant);
